...
export const Quotes = () => {
  ...
  return (
    <section className="max-w-screen-xl mx-3 lg:mx-auto my-32">
      ...
      <AnimateSharedLayout>
        <div className="grid grid-cols-3 mt-12 mb-20">
            ...
            <motion.div layout className="flex flex-col items-center relative">
              {i === visibleIndex && (
                <motion.div
                  ...
                  animate={{ width: '100%' }}
                  initial={{ x: 0 }}
                  className="w-full h-1 rounded-full bg-white absolute left-0"
                ></motion.div>
              )}
              <motion.blockquote
                ...
                variants={quote}
                key={i}
                className="relative text-2xl font-default lg:mt-8 max-w-lg leading-normal lg:my-16 pt-20 pb-10 px-8 mt-5 rounded-lg shadow-md"
              >
                ‟ {text} ”
              </motion.blockquote>
              <motion.button
                ...
                className="text-xl font-breadText mt-auto border-b border-gray-100 p-8 w-full text-center relative overflow-hidden"
                onClick={() => showQuote(i)}
              >
